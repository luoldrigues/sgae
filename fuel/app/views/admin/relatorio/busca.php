...
<div class="my-content-box">
  ...
  <form class="form-horizontal" action="<?php echo Uri::current(); ?>" method="POST" target="_blank">
...
<div class="my-content-box">
  ...
  <form class="form-horizontal" action="<?php echo Uri::current(); ?>" method="POST" target="_blank">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <select class="span4" name="idAluno" id="idAluno">
          <?php
            if(isset($alunos) AND is_array($alunos)){
