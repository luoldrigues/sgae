...
<div class="container">
  ...
  <form class="form-signin" action="<?php echo Uri::current(); ?>" method="POST">
    ...
    <input type="text" name="username" class="input-block-level" placeholder="Digite seu RA ou Email" required>
    <input type="password" name="password" class="input-block-level" placeholder="Digite sua Senha" required>
